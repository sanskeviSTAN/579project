...
---Results---
Actor loss decreases smoothly and critic loss stabilizes once the pruning mask is frozen. Add 1-2 sentences on how sparsity level affected final return once you've compared 0.90 vs 0.95 vs 0.98.
